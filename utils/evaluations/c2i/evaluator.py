...
def main():
    ...
    parser.add_argument("--ref_batch", default="utils/evaluations/VIRTUAL_imagenet256_labeled.npz", help="path to reference batch npz file")
    parser.add_argument("--sample_batch", default="utils/evaluations/admnet_upsampled_imagenet256.npz", help="path to sample batch npz file")
    ...
    print('x'*10, f"sample_batch: {args.sample_batch}", 'x'*10)
